...
> Exercice : charger les données de Carvalho2018sup4.xlsx.
> Garder les données des lignes ayant TOTAL dans la colonne "Habitat type"
> Faire une jointure (left_join) pour inclure les données de Carvalho dans Vahatra
